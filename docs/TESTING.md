...
- Select the settings button and confirm language, backup, restore, CSV, privacy, sharing, and offline information open on a separate screen; Close returns to the dashboard.
